class colorCode {
    ...
    getHex() {
        var output = ''; var colorChannels = [this.red, this.green, this.blue]; var dedupeFlag = !0; colorChannels.forEach(value => { output += this.numberToHex(value); if (!this.isDoubleChar(this.numberToHex(value))) { dedupeFlag = !1 } }); if (this.alpha !== undefined) { dedupeFlag = !1; output += this.decToHexAlpha(this.alpha) }
